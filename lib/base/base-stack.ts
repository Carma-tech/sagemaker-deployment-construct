...
export class SageMakerDeployment extends Construct {
  ...
  private createExecutionRole(): iam.Role {
    ...
    role.addToPolicy(new iam.PolicyStatement({
      ...
      resources: [
        ...
        `arn:aws:s3:::${this.props.modelArtifacts.bucketName}/${this.props.modelArtifacts.objectKey}`,
      ],
    }));
    ...
    role.addToPolicy(new iam.PolicyStatement({
      ...
      resources: ['*'], // Will be refined with actual resource ARNs
    }));
  ...
  private getContainerImage(): string {
    ...
    // Placeholder for now
    return '123456789012.dkr.ecr.us-east-1.amazonaws.com/sagemaker-container:latest';
  }
